...
`r knitr::include_graphics("static/rstudio-editor.png")`
...
`r knitr::include_graphics("static/01-project.png")`
...
`r knitr::include_graphics("static/02-project.png")`
...
`r knitr::include_graphics("static/03-project.png")`
...
`r knitr::include_graphics("static/save-workspace.png")`
...
`r knitr::include_graphics("static/genesis1300.png")`

They can be used to make beautiful graphics for the BBC.

`r knitr::include_graphics("static/bbplot_example_plots.png")`
